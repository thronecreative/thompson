...
<div id="header" class="header">
	<div class="header__inner">
		<div class="logo"><a href="" data-scroll-nav="0"><img src="./images/tandco-logo.svg" alt="Thompson & co. logo"></a></div>
		
		<nav class="nav">
			<ul>
				<li class="nav__item"><a href="" class="nav__link" data-scroll-nav="1">What We Do.</a></li>
				<li class="nav__item"><a href="" class="nav__link" data-scroll-nav="2">Who We Are.</a></li>
...
<div id="intro" class="section" data-scroll-index="0">
	<div class="section__inner">
		<div class="section__info"  data-stellar-ratio=".8">
			<h1 class="section__heading">Reputation Matters</h1>
			<h2 class="section__sub-heading">Legal Services to Protect Your Brand.</h2>
		</div>
		
		
		<div class="section__cta" data-stellar-ratio=".7"><a href="" class="ion-chevron-down" data-scroll-nav="1"></a></div>

		<div class="section__bg" data-stellar-ratio=".8">
			<svg width='100%' height='100%' viewBox="0 0 100 100" preserveAspectRatio="none">
				<polygon points="0,11 100,3 100,45 0,50" fill="#fff" />
			</svg>
		</div>
	</div>
</div>

<div id="about" class="section" data-scroll-index="1">
	<div class="section__inner"  data-stellar-ratio="1.2">
		...
		<div id="trademark" class="section__info" >
			...
			<ul>
				...
				<li>Opposition Proceedings (TTAB)</li>
				<li>Cancellation Proceedings (TTAB)</li>
				<li>Domain Name Disputes (UDRP/URS)</li>
...
<div id="team" class="section" data-scroll-index="2">
